...
export function deriveSuggestions(
  ...
  // Scheduling detection is handled by the AI suggestion layer (agentSuggestions).
  // The AI reads email bodies and understands intent — it decides whether to suggest
  // book_and_reply vs send_email based on context, not regex.
