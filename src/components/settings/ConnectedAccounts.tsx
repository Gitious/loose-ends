...
const accounts: AccountCard[] = [
  {
    ...
    connectUrl: "/api/auth/login?connection=google-oauth2",
  },
  {
    id: "github",
    name: "GitHub",
    ...
    connectUrl: "/api/auth/login?connection=github",
  },
];
        ...
        {accounts.map((account, i) => (
          ...
          >
            ...
            <a
              ...
              className="mt-auto inline-flex items-center justify-center h-10 px-5 rounded-lg bg-le-accent text-le-void text-sm font-semibold transition-transform hover:scale-105 hover:shadow-[0_0_20px_rgba(108,140,255,0.3)]"
            >
              Connect
            </a>
          </motion.div>
